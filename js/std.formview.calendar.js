...
// @todo Fix this class, send the objId and cssClassName like the others controls
var DateField = new Class({
    ...
    options: {
        ...
        days: MooTools.lang.setLanguage(controller.language).get('Date').days, // days of the week starting at sunday
        direction: 0, // -1 past, 0 past + future, 1 future
        draggable: true,
        months: MooTools.lang.setLanguage(controller.language).get('Date').months,
    ...
    initialize: function(obj, options) {
        ...
        {
            calendarElId = propName + '_calendar_div';
            this.calendar = $(calendarElId);
            break;
        }
        
        if (this.calendar == null)
        {
            this.calendar = new Element('div', { 'id' : calendarElId,
            ...
            if (window.ie6) {
                this.iframe = new Element('iframe', { 'id' : calendarElId,
