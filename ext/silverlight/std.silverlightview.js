...
Silverlight.createObject = function(source, parentElement, id, properties, events, initParams, userContext)
{
    ...
    if (parentElement)
    {
        $(parentElement).set('html', slPluginHTML);
    }
    else
    {
        return slPluginHTML;
...
function embedSilverlight(parentElement, userContext)
{
    Silverlight.createObject("sample.xaml", parentElement, parentElement + '_plugin',
        { 
            height: 500, width: 500, alt: 'No Silverlight', version: "2.0.40115.0"
        },
        {
            onError: function(sender, args) { console.log(sender); console.log(args); },
            onLoad: function(plugIn, userContext, sender)
            {
                var xamlName = plugIn.id.replace('_plugin', '_xaml');
                var xamlFragment = $(xamlName).get('html');
                xamlFragment = xamlFragment.substr(xamlFragment.indexOf('<Grid'));
                xamlFragment = xamlFragment.substr(0, xamlFragment.indexOf(']]-->'));
