...
if ($savedPrecision < 16) ini_set('precision',16);

/**
 * ExcelCalculation_Functions
 *
 * @package    WebCore
 * @subpackage Excel
 */
class ExcelCalculation_Functions extends HelperBase
{
	/** constants */
	 ...
	 *													ExcelCalculation_Functions::COMPATIBILITY_EXCEL			'Excel'
	 *													ExcelCalculation_Functions::COMPATIBILITY_GNUMERIC		'Gnumeric'
	 *													ExcelCalculation_Functions::COMPATIBILITY_OPENOFFICE	'OpenOfficeCalc'
	 ...
	 *												Permitted values are:
	 *													ExcelCalculation_Functions::RETURNDATE_PHP_NUMERIC		'P'
	 *													ExcelCalculation_Functions::RETURNDATE_PHP_OBJECT		'O'
	 *													ExcelCalculation_Functions::RETURNDATE_EXCEL			'E'
	 *	@return	 boolean							Success or failure
	 */
	...
	public static function LOGICAL_OR() {
		...
		// Return
		if ($argCount == 0) return self::$_errorCodes['value'];
	...
	public static function MAXA() {
		...
		// Return
		if(is_null($returnValue)) return 0;
	...
	public static function AVERAGE() {
		...
		if ($aCount > 0) return $returnValue / $aCount;
...
//			$CumPGuessMinus1 = $CumPGuess - $PGuess;
	...
	public static function DATE($year = 0, $month = 1, $day = 1) {
		...
		$baseYear = ExcelShared_Date::getExcelCalendar();
		// Validate parameters
		...
		// Execute function
		$excelDateValue = ExcelShared_Date::FormattedPHPToExcel($year, $month, $day);
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: return (float) $excelDateValue;
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: return (integer) ExcelShared_Date::ExcelToPHP($excelDateValue);
												  break;
			case self::RETURNDATE_PHP_OBJECT	: return ExcelShared_Date::ExcelToPHPObject($excelDateValue);
												  break;
		}
	}
	...
	public static function TIME($hour = 0, $minute = 0, $second = 0) {
		...
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: $date = 0;
												  $calendar = ExcelShared_Date::getExcelCalendar();
												  if ($calendar != ExcelShared_Date::CALENDAR_WINDOWS_1900) {
													 $date = 1;
												  }
												  return (float) ExcelShared_Date::FormattedPHPToExcel($calendar, 1, $date, $hour, $minute, $second);
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: return (integer) ExcelShared_Date::ExcelToPHP(ExcelShared_Date::FormattedPHPToExcel(1970, 1, 1, $hour-1, $minute, $second));	// -2147468400; //	-2147472000 + 3600
												  break;
	...
	public static function DATEVALUE($dateValue = 1) {
		...
		if (($PHPDateArray !== False) && ($PHPDateArray['error_count'] == 0)) {
			...
			$excelDateValue = floor(ExcelShared_Date::FormattedPHPToExcel($PHPDateArray['year'],$PHPDateArray['month'],$PHPDateArray['day'],$PHPDateArray['hour'],$PHPDateArray['minute'],$PHPDateArray['second']));
	...
	private static function _getDateValue($dateValue) {
		if (!is_numeric($dateValue)) {
			...
			if ((is_object($dateValue)) && ($dateValue instanceof ExcelShared_Date::$dateTimeObjectType)) {
				$dateValue = ExcelShared_Date::PHPToExcel($dateValue);
			} else {
	...
	public static function TIMEVALUE($timeValue) {
		...
		if ((($PHPDateArray = date_parse($timeValue)) !== False) && ($PHPDateArray['error_count'] == 0)) {
			if (self::$compatibilityMode == self::COMPATIBILITY_OPENOFFICE) {
				$excelDateValue = ExcelShared_Date::FormattedPHPToExcel($PHPDateArray['year'],$PHPDateArray['month'],$PHPDateArray['day'],$PHPDateArray['hour'],$PHPDateArray['minute'],$PHPDateArray['second']);
			} else {
				$excelDateValue = ExcelShared_Date::FormattedPHPToExcel(1900,1,1,$PHPDateArray['hour'],$PHPDateArray['minute'],$PHPDateArray['second']) - 1;
			}

			switch (self::getReturnDateType()) {
				case self::RETURNDATE_EXCEL			: return (float) $excelDateValue;
													  break;
				case self::RETURNDATE_PHP_NUMERIC	: return (integer) $phpDateValue = ExcelShared_Date::ExcelToPHP($excelDateValue+25569) - 3600;;
													  break;
	...
	public static function DATETIMENOW() {
		...
		$retValue = False;
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: $retValue = (float) ExcelShared_Date::PHPToExcel(time());
												  break;
	...
	public static function DATENOW() {
		...
		date_default_timezone_set('UTC');
		$retValue = False;
		$excelDateTime = floor(ExcelShared_Date::PHPToExcel(time()));
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: $retValue = (float) $excelDateTime;
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: $retValue = (integer) ExcelShared_Date::ExcelToPHP($excelDateTime) - 3600;
												  break;
			case self::RETURNDATE_PHP_OBJECT	: $retValue = ExcelShared_Date::ExcelToPHPObject($excelDateTime);
												  break;
		}
		date_default_timezone_set($saveTimeZone);
	...
	public static function DAYS360($startDate = 0, $endDate = 0, $method = false) {
		...
		// Execute function
		$PHPStartDateObject = ExcelShared_Date::ExcelToPHPObject($startDate);
		$startDay = $PHPStartDateObject->format('j');
		$startMonth = $PHPStartDateObject->format('n');
		$startYear = $PHPStartDateObject->format('Y');

		$PHPEndDateObject = ExcelShared_Date::ExcelToPHPObject($endDate);
	...
	public static function WORKDAY($startDate,$endDays) {
		...
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: return (float) $endDate;
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: return (integer) ExcelShared_Date::ExcelToPHP($endDate);
												  break;
			case self::RETURNDATE_PHP_OBJECT	: return ExcelShared_Date::ExcelToPHPObject($endDate);
												  break;
		}
	}
	...
	public static function DAYOFMONTH($dateValue = 1) {
		...
		// Execute function
		$PHPDateObject = ExcelShared_Date::ExcelToPHPObject($dateValue);
	...
	public static function HOUROFDAY($timeValue = 0) {
		...
		if (is_real($timeValue)) {
			$timeValue = ExcelShared_Date::ExcelToPHP($timeValue);
		}
	...
	public static function EDATE($dateValue = 1, $adjustmentMonths = 0) {
		...
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: return (float) ExcelShared_Date::PHPToExcel($PHPDateObject);
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: return (integer) ExcelShared_Date::ExcelToPHP(ExcelShared_Date::PHPToExcel($PHPDateObject));
												  break;
	...
	public static function CELL_ADDRESS($row, $column, $relativity=1, $referenceStyle=True, $sheetText='') {
		...
		if (!$referenceStyle) {
			...
			$column = ExcelCell::stringFromColumnIndex($column-1);
	...
	public static function COLUMN($cellAddress=Null) {
		...
		foreach($cellAddress as $columnKey => $value) {
			return ExcelCell::columnIndexFromString($columnKey);
		}
	}	//	function COLUMN()
	...
	public static function OFFSET($cellAddress=Null,$rows=0,$columns=0,$height=null,$width=null) {
		...
		foreach($cellAddress as $startColumnKey => $rowValue) {
			$startColumnIndex = ExcelCell::columnIndexFromString($startColumnKey);
		...
		$endColumnIndex = ExcelCell::columnIndexFromString($endColumnKey);
		...
		$startColumnKey = ExcelCell::stringFromColumnIndex($startColumnIndex);
		$endColumnKey = ExcelCell::stringFromColumnIndex($endColumnIndex);
